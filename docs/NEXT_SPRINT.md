...
| Step | Work |
|---|---|
| 1 | Add answer-support verification before returning synthesized answers. |
| 2 | Add selective embedding worker with pgvector writes for only queries/documents that need semantic retrieval. |
