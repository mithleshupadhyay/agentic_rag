...
| `Dockerfile.app` | Builds the FastAPI API container. | Add production image hardening, dependency vulnerability scanning, build caching, runtime user permissions review, and separate worker image targets when workers are added. | Medium |
